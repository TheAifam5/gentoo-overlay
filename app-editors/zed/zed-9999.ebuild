...
SRC_URI+="
	amd64? (
		https://github.com/livekit/rust-sdks/releases/download/webrtc-${WEBRTC_VERSION}/webrtc-linux-x64-release.zip
			-> webrtc-${WEBRTC_VERSION}-linux-x64-release.zip
	)
	arm64? (
		https://github.com/livekit/rust-sdks/releases/download/webrtc-${WEBRTC_VERSION}/webrtc-linux-arm64-release.zip
			-> webrtc-${WEBRTC_VERSION}-linux-arm64-release.zip
	)
"
LICENSE="GPL-3+"
